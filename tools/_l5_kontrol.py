# Gecici denetleyici: L5 senaryolarini teslim listesine gore kontrol eder. Is bitince silinir.
import json
import re
import sys
...
# L5 icin aksan tablosu: S1 en-GB + en-AU, S2 en-GB, S3 en-GB + en-CA (+ en-AU), S4 en-AU
BEKLENEN_AKSAN = {1: {"en-GB", "en-AU"}, 2: {"en-GB"},
                  3: {"en-GB", "en-CA", "en-AU"}, 4: {"en-AU"}}
...
for s in range(1, 5):
    ...
    if d.get("script_id") != etiket or d.get("test_id") != "L5" or d.get("section") != s:
