...
5. Apply the caps listed under each criterion, **last of all**. A cap is a **ceiling, never a
   ...
   you read off the table. Before writing down a band equal to a cap value, check that the letter
...
they actually need. A letter that trips a "max 5" cap has not thereby earned 5; read the 4 and 3
