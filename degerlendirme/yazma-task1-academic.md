...
- No overview anywhere in the response → **max 5**.
...
- To reach **7 or above** the response must contain at least four accurate, task-appropriate items
  ...
  fell steadily, the figure for*). Count them; if you cannot name four, the band is 6 or lower.
...
```json
{
  ...
  "criteria": [
    ...
    { "name": "lexical_resource", "band": 5.0, "why": "...", "quote": "..." },
    { "name": "grammatical_range_accuracy", "band": 4.0, "why": "...", "quote": "..." }
  ],
  "lowest_criterion": "grammatical_range_accuracy",
  "rewrites": [
